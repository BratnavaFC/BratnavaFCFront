            ...
            <div className="w-full sm:max-w-md max-h-[90vh] rounded-t-2xl sm:rounded-2xl bg-white shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="px-5 py-4 border-b flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-slate-900">Encerrar votação</p>
                            <p className="text-xs text-slate-400 truncate max-w-[200px]">{pollTitle}</p>
                        </div>
                    </div>
                    ...
                    <div className="rounded-xl border border-slate-200 bg-slate-50/60 p-4">
                        <label className="flex items-center justify-between gap-3 cursor-pointer">
                            <div>
                                ...
                                <p className="text-xs text-slate-400 mt-0.5">Com base no resultado desta votação</p>
                            </div>
                            <div
                                onClick={() => setCreateEvent(p => !p)}
                                className={`relative h-6 w-11 rounded-full transition-colors cursor-pointer shrink-0 ${createEvent ? 'bg-violet-600' : 'bg-slate-200'}`}
                            >
