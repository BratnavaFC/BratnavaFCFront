            ...
            {[1, 2, 3, 4, 5].map((star) => (
                <button
                    ...
                    className={[
                        ...
                        star <= (value ?? 0) ? "text-amber-400" : "text-slate-300 dark:text-slate-600 hover:text-amber-300",
                    ].join(" ")}
                ...
                <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-slate-800 shadow-2xl dark:shadow-none dark:ring-1 dark:ring-slate-700 border flex flex-col overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-5 py-4 border-b dark:border-slate-700 shrink-0">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-base font-semibold text-slate-900 dark:text-white">Adicionar convidado</div>
                                <div className="text-xs text-slate-500 dark:text-slate-400">Sem conta no sistema</div>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="px-5 py-5 space-y-4">
                        <div className="space-y-1">
                            <label className="text-sm font-medium text-slate-700 dark:text-slate-200">Nome do convidado</label>
                            <input
                                ref={nameRef}
                        ...
                        <label className="flex items-center gap-2 cursor-pointer select-none">
                            ...
                            />
                            <span className="text-sm font-medium text-slate-700 dark:text-slate-200 inline-flex items-center gap-1">Goleiro <IconRenderer value={resolveIcon(_icons, 'goalkeeper')} size={14} /></span>
                        </label>
